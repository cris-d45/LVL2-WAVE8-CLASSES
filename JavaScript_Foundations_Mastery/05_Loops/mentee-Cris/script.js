...
//console log outside of the for loop when you are only wanting a Sum total. Otherwise, if you console inside...numbers will go through every iteration.
...
//When adding the sum and current, make sure sum is first.
...
let dailyTasks = ["Workout", "MealPrep", "Homework"];
